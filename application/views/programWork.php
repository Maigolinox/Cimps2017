...
<div style="text-align:right"><a class="btn btn-primary btn-large" href="http://cimps.cimat.mx/registration_system/index.php/programWork/download">Descargar</a></div>
<?php } ?>
<table id="program">
	<h2 align="center"> Programa Workshop </h2>
<?php $fecha = ""; 
