...
<div class="row">
	<div class="col-md-8">
    <a class="btn btn-primary" href="http://cimps.cimat.mx/registration_system/index.php/descargas/constanciaPDF">Descargar constancia de asistencia en PDF</a><br/><br/>
    <a class="btn btn-primary" href="<?php echo site_url("descargas/presentacionesAcademicas") ?>">Presentaciones Académicas</a>
	</div>
</div>		
