...
<div style="text-align:right"><a class="btn btn-primary btn-large" href="http://cimps.cimat.mx/registration_system/index.php/program/download">Download</a></div>
<?php } ?>
<table id="program">
	<h2 align="center"> Conference Programme </h2>
<?php $fecha = ""; 
while($evento = current($eventos)){ ?>
 ...
 <?php next($eventos); } 
	...
	function fecha_larga($fecha_corta){
		$dias = array("Domingo","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday");
		$meses = array("January","February","March","April","May","June","July","August","September","October","November","December");
		return $dias[date('w', strtotime($fecha_corta))].", ".$meses[date('n', strtotime($fecha_corta))-1]." ".date('d', strtotime($fecha_corta)). ", ".date('Y', strtotime($fecha_corta));
