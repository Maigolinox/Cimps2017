...
class Descargas extends CI_Controller {
	...
	public function constanciaPDF(){
		...
		$this->image_moo
		->load('/home1/ingsofti/public_html/cimps/registration_system/assets/img/CIMPS2016cc.jpg')
		->make_watermark_text($user->name, "/home1/ingsofti/public_html/cimps//registration_system/assets/fonts/timesbd.ttf", 32, "#254061")
		->watermark(5)
		->save("/home1/ingsofti/public_html/cimps/registration_system/assets/img/c".$user->id.".jpg");
